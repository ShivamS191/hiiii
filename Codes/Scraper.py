#By this code we accept github token from user and then we perform set of operation by finding all the details as per the given criteria and prepare 2 csv files as user.csv and reposeriteries.csv
import requests
import pandas as pd
import time
import logging
...
def main():
    ...
    # Search for users in Berlin with >200 followers 
